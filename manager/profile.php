...
<?php
  // insert Code Start
      if(isset($_POST['edit'])){
            ...
            $about = $_POST['about'];
            $q = "insert into manage_details values('','$dob','$gender','$address','$city','$country','$postal_code','$about','$id',now())";
  ...
  // Update Code Start
    if(isset($_POST['update'])){
      ...
      $query = "update manage_details set dob='$dob',gender='$gender',address='$address',city='$city',country='$country',postal_code='$postal_code',about='$about',created_time=now() where manage_id ='$id'";
      ...
      <div class="container-fluid d-flex  align-items-center">
        <div class="row">
          <div class="col-lg-12 col-md-10 mt-6">
            <h1 class="display-2 text-white">Hello <?php echo $_SESSION['manage_name'];  ?> </h1>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <form method="POST">
                <?php 
                  $id = $_SESSION['manage_id'];
                  $sql = "SELECT * FROM manager WHERE manager.manage_id = $id;";
                  ...
                  <div class="row">
                      <div class="col-lg-6">
                        <div class="form-group">
                          ...
                          <input type="text" id="input-id" class="form-control" value="<?php echo $row['manage_id']; ?>" disabled>
                        </div>
                      </div>
                      <div class="col-lg-6">
                        <div class="form-group">
                          <label class="form-control-label" for="input-email">Employee Name</label>
                          <input type="text" id="input-email" class="form-control" value="<?php echo $row['manage_name']; ?>">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="form-group">
                          ...
                          <input type="text" id="input-username" class="form-control" placeholder="Username" value="<?php echo $row['manage_email']; ?>" >
                        </div>
                      </div>
                      <div class="col-lg-6">
                        <div class="form-group">
                          <label class="form-control-label" for="input-email">Contacts Number</label>
                          <input type="number" id="input-email" class="form-control" value="<?php echo $row['manage_mob'];?>">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-lg-12">
                        <div class="form-group">
                          ...
                          <input type="date" id="input-doj" class="form-control"  value="<?php echo $row['manage_doj']; ?>" disabled>
                        </div>
                      </div>
               ...
               <?php 
                  $id = $_SESSION['manage_id'];
                  $sql = "SELECT * FROM manage_details WHERE manage_details.manage_id = $id";
                  $result = mysqli_query($con, $sql);
